...
import 'package:adorafrika/pages/services/api.dart';
    ...
    switch (type) {
      case 'playlist':
        SaavnAPI()
            ...
            .then((value) {
          setState(() {
            songList = value['samerythme'] as List;
            fetched = true;
            loading = false;
          });
      ...
      default:
        ...
        ShowSnackBar().showSnackBar(
          context,
          'Error: Unsupported Type Playlist}',
          duration: const Duration(seconds: 3),
        );
        break;
    }
                  ...
                  : BouncyImageSliverScrollView(
                      ...
                      actions: [
                        MultiDownloadButton(
                          data: songList,
                          playlistName:
                              widget.listItem['genre']?.toString() ?? 'Songs',
                        ),
                        IconButton(
                            ...
                            return ListTile(
                              ...
                              leading: Card(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  imageUrl:
                                      entry["image"] ?? SizeConfig.defaultImageUrl,
