...
,child: VideoPlayer(videoPlayerController!))
                ...
                : AspectRatio(
                    aspectRatio: 16.0 / 9.0,
                    child: Container(child: Text('Veuillez définir la vidéo',), color: Colors.grey, alignment: Alignment.center,),
                  ),
                   Padding(
  ...
  children: [
       ...
       InkWell(onTap: _getVideofromgallery,
         child: Icon(
   ...
   Text("ou", style: TextStyle(color: Colors.black, fontSize: 18),),
   SizedBox(
   width: 10,
 ),
 ...
 Container(
  ...
  style:TextStyle(color: Colors.black),
   ...
   // shape: CircleBorder(),
    ...
    foregroundColor: Colors.yellow.shade600, // <-- Splash color
  ),
                                   onPressed: (){
                                   // print("Valeur:  ${isNotNull(_video?.path)}  val :  ${_video?.path}");
                                   savePanegyrique();
