...
class MyTheme with ChangeNotifier {
  ...
  void refresh() {
    ...
    accentColor = settingsBox.get('themeColor', defaultValue: 'Green') as String;
    canvasColor =
  ...
  Color getColor(String color, int hue) {
    switch (color) {
      ...
      default:
        return _isDark ? Colors.green : Colors.green;
    }
  }
  ...
  Color currentColor() {
    switch (accentColor) {
      ...
      default:
        return _isDark ? SizeConfig.primaryColor : SizeConfig.primaryColor;
    }
  }
