...
import 'package:adorafrika/helpers/add_mediaitem_to_queue.dart';
...
import 'package:adorafrika/services/youtube_services.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton(
      ...
      onSelected: (value) {
        switch (value) {
          case 3:
            Share.share(widget.data['fichier'].toString());
            break;
